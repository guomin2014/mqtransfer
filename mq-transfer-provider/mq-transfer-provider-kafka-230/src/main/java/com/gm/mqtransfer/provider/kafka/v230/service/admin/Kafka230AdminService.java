package com.gm.mqtransfer.provider.kafka.v230.service.admin;
...
public class Kafka230AdminService implements AdminService{
	private static final Logger LOGGER = LoggerFactory.getLogger(Kafka230AdminService.class);
	private static String KAFKA_TOPICS_PATH = "/brokers/topics";
	private final ZkClient _kfkZkClient;
	
	public Kafka230AdminService(KafkaClusterInfo clusterInfo) {
		LOGGER.info("Trying to init Kafka230AdminService {}({}) with ZK: {}", clusterInfo.getName(), clusterInfo.getCode(), clusterInfo.getZkUrl());

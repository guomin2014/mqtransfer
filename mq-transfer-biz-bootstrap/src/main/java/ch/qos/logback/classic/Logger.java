...
public final class Logger implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
    ...
    /**
     * add this map to store loggerContext for each biz module
     */
    final transient Map<ClassLoader, LoggerContext> loggerContextMap = Collections.synchronizedMap(new WeakHashMap<>());
    

    Logger(String name, Logger parent, LoggerContext loggerContext) {
        this.name = name;
        this.parent = parent;
        //add this loggerContext to loggerContextMap
    ...
    Logger createChildByLastNamePart(final String lastPart) {
        ...
        if (this.isRootLogger()) {
            childLogger = new Logger(lastPart, this, this.getLoggerContext());
        } else {
            childLogger = new Logger(name + CoreConstants.DOT + lastPart, this, this.getLoggerContext());
        }
    ...
    Logger createChildByName(final String childName) {
        ...
        Logger childLogger;
        childLogger = new Logger(childName, this, this.getLoggerContext());
        childrenList.add(childLogger);
        childLogger.effectiveLevelInt = this.effectiveLevelInt;
        return childLogger;
    }
    ...
    private void filterAndLog_0_Or3Plus(final String localFQCN, final Marker marker, final Level level, final String msg, final Object[] params,
        ...
        final FilterReply decision = getLoggerContext().getTurboFilterChainDecision_0_3OrMore(marker, this, level, msg, params, t);
    ...
    private void filterAndLog_1(final String localFQCN, final Marker marker, final Level level, final String msg, final Object param, final Throwable t) {
        ...
        final FilterReply decision = getLoggerContext().getTurboFilterChainDecision_1(marker, this, level, msg, param, t);
    ...
    private void filterAndLog_2(final String localFQCN, final Marker marker, final Level level, final String msg, final Object param1, final Object param2,
        ...
        final FilterReply decision = getLoggerContext().getTurboFilterChainDecision_2(marker, this, level, msg, param1, param2, t);
    ...
    private FilterReply callTurboFilters(Marker marker, Level level) {
        return getLoggerContext().getTurboFilterChainDecision_0_3OrMore(marker, this, level, null, null, null);
    }
    ...
    public LoggerContext getLoggerContext() {
    	// diff, get loggerContext from loggerContextMap
